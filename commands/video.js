...
async function videoCommand(sock, chatId, message) {
    try {
        ...
        await sock.sendMessage(chatId, {
            ...
            caption: `*${videoData.title || videoTitle || 'Video'}*\n\n> *_Downloaded by IM AURA Bot XMD_*`
        }, { quoted: message });


    } catch (error) {
        console.error('[VIDEO] Command Error:', error?.message || error);
        await sock.sendMessage(chatId, { text: '🛈`please upgrade to the latest version of whatsapp to use this feature` ' + (error?.message || '🛈`Unknown error`') }, { quoted: message });
    }
}
